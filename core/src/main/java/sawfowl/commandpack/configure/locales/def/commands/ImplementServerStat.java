...
import sawfowl.commandpack.configure.locales.abstractlocale.commands.serverstat.Buttons;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.serverstat.Memory;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.serverstat.Worlds;
import sawfowl.commandpack.configure.locales.def.commands.serverstat.ImplementAboutMod;
import sawfowl.commandpack.configure.locales.def.commands.serverstat.ImplementAboutPlugin;
import sawfowl.commandpack.configure.locales.def.commands.serverstat.ImplementButtons;
import sawfowl.commandpack.configure.locales.def.commands.serverstat.ImplementMemory;
import sawfowl.commandpack.configure.locales.def.commands.serverstat.ImplementWorlds;
...
public class ImplementServerStat implements ServerStat {
	...
	private Component modsNotFound = TextUtils.deserializeLegacy("&eThe player has no mods, or it is not possible to identify them.");

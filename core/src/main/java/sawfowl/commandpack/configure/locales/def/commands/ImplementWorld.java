...
import sawfowl.commandpack.configure.locales.abstractlocale.commands.world.Difficulty;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.world.GameMode;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.world.GameRule;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.world.Generate;
import sawfowl.commandpack.configure.locales.abstractlocale.commands.world.SpawnLogic;
import sawfowl.commandpack.configure.locales.def.commands.world.ImplementDifficulty;
import sawfowl.commandpack.configure.locales.def.commands.world.ImplementGameMode;
import sawfowl.commandpack.configure.locales.def.commands.world.ImplementGameRule;
import sawfowl.commandpack.configure.locales.def.commands.world.ImplementGenerate;
import sawfowl.commandpack.configure.locales.def.commands.world.ImplementSpawnLogic;

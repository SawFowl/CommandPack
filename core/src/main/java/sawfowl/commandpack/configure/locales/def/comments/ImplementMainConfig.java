package sawfowl.commandpack.configure.locales.def.comments;
...
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.Afk;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.Economy;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.Punishment;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.RandomTeleport;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.RestrictEntitySpawn;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.RestrictMods;
import sawfowl.commandpack.configure.locales.abstractlocale.comments.mainconfig.SpawnData;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.IgnorePackets;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementAfk;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementEconomy;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementPunishment;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementRandomTeleport;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementRestrictEntitySpawn;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementRestrictMods;
import sawfowl.commandpack.configure.locales.def.comments.mainconfig.ImplementSpawnData;

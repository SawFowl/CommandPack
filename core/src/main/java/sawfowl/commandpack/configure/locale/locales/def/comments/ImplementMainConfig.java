...
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.IgnorePackets;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementAfk;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementEconomy;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementPunishment;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementRandomTeleport;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementRestrictEntitySpawn;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementRestrictMods;
import sawfowl.commandpack.configure.locale.locales.def.comments.mainconfig.ImplementSpawnData;

...
public class ImplementKits implements Kits {
	...
	@Setting("CreateLore")
	Component createLore = TextUtils.deserializeLegacy("&aA description has been added to the kit for the ruault localization. To change it, edit the kit configuration file.");
	@Setting("GiveLimit")

...
public class ImplementTables implements Tables {
	...
	@Setting("Accounts")
	private String accounts = "This table is for recording account data without UUIDs. It is suitable for those cases when there is an attempt to change the balance of a player who has not yet logged in to the server. After the player login in, the data will be resaved with the UUID added.";

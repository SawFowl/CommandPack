...
import sawfowl.commandpack.configure.locale.locales.abstractclasses.commands.SetHome;
...
public class ImplementSetHome implements SetHome {
	...
	@Setting("Limit")
	private Component limit = TextUtils.deserializeLegacy("&cYour limit&7(" + Placeholders.LIMIT + "&7)&c does not allow you to set a new home point.");
	@Setting("Success")

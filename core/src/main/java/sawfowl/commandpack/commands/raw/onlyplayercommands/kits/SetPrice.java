...
public class SetPrice extends AbstractKitsEditCommand {
	...
	public List<RawArgument<?>> arguments() {
		return Arrays.asList(
			...
			RawArguments.createCurrencyArgument(false, false, 1, null, null, null, LocalesPaths.COMMANDS_EXCEPTION_VALUE_NOT_PRESENT),
			RawArguments.createBigDecimalArgument("Price", new ArrayList<>(), false, false, 2, null, null, null, null, LocalesPaths.COMMANDS_EXCEPTION_VALUE_NOT_PRESENT)
		);
	}

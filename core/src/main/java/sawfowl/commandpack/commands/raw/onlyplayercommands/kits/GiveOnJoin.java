...
public class GiveOnJoin extends AbstractKitsEditCommand {
	...
	public GiveOnJoin(CommandPackInstance plugin) {
		super(plugin);
	}
	...
	public List<RawArgument<?>> arguments() {
		return Arrays.asList(
			...
			RawArguments.createBooleanArgument(new RawBasicArgumentData<Boolean>(null, "Value", 1, null, null), RawOptional.notOptional(), locale -> getExceptions(locale).getValueNotPresent())
		);
	}

...
public class Sudo extends AbstractRawCommand {
	...
	public List<RawArgument<?>> arguments() {
		return Arrays.asList(
			RawArguments.createPlayerArgument(false, false, 0, null, null, null, LocalesPaths.COMMANDS_EXCEPTION_PLAYER_NOT_PRESENT),
			RawArguments.createRemainingJoinedStringsArgument("Command", false, false, 1, null, null, null, null, LocalesPaths.COMMANDS_EXCEPTION_VALUE_NOT_PRESENT)
		);
	}

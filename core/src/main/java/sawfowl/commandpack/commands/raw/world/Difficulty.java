...
public class Difficulty extends AbstractWorldCommand {
	...
	public void process(CommandCause cause, Audience audience, Locale locale, boolean isPlayer, String[] args, Mutable arguments) throws CommandException {
		...
		world.properties().setDifficulty(difficulties.get(getString(args, cause, 1).get()).get());
	...
	public List<RawArgument<?>> arguments() {
		...
		return Arrays.asList(
			createWorldArg(),
			RawArguments.createStringArgument("Difficulty", difficulties.keySet(), false, false, 1, null, null, LocalesPaths.COMMANDS_EXCEPTION_VALUE_NOT_PRESENT)
		);
	}

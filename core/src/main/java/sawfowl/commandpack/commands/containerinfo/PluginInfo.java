...
public class PluginInfo extends AbstractInfoCommand {
	...
	public List<ParameterSettings> getParameterSettings() {
		return Arrays.asList(ParameterSettings.of(CommandParameters.PLUGIN, false, locale -> plugin.getLocales().getAsReferenced(locale).getCommandExceptions().getPluginNotPresent()));
	}

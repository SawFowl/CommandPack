...
public class LocalesPaths {
	...
	public static final Object[] COMMANDS_SERVERSTAT_PLUGIN_VERSION = {PATH_COMMANDS, COMMAND_SERVERSTAT, "PluginVersion"};
	...
	public static final Object[] COMMANDS_SERVERSTAT_PLUGIN_LINKS_HOME = {PATH_COMMANDS, COMMAND_SERVERSTAT, "HomeLink"};
	public static final Object[] COMMANDS_SERVERSTAT_PLUGIN_LINKS_SOURCE = {PATH_COMMANDS, COMMAND_SERVERSTAT, "SourceCodeLink"};
	public static final Object[] COMMANDS_SERVERSTAT_PLUGIN_LINKS_ISSUES = {PATH_COMMANDS, COMMAND_SERVERSTAT, "IssuesLink"};
	public static final Object[] COMMANDS_SERVERSTAT_HEADER_MODS = {PATH_COMMANDS, COMMAND_SERVERSTAT, "HeaderMods"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_INFO_BUTTON = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModInfoButton"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_ID = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModID"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_NAME = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModName"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_VERSION = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModVersion"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_DESCRIPTION = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModDecription"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_DEPENDECIES = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModDependecies"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_LINKS = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModLinks"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_URL_UPDATE = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModUpdateLink"};
	public static final Object[] COMMANDS_SERVERSTAT_MOD_URL_ISSUES = {PATH_COMMANDS, COMMAND_SERVERSTAT, "ModIssuesLink"};

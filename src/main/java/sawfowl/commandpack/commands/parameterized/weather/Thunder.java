...
public class Thunder extends AbstractParameterizedCommand {
	...
	public Thunder(CommandPackPlugin plugin) {
		super(plugin);
	}
	...
	private void setWeather(Audience src, Locale locale, ServerWorld world, Optional<Integer> duration) {
		...
		} else world.setWeather(WeatherTypes.THUNDER.get());
		src.sendMessage(getText(locale, LocalesPaths.COMMANDS_WEATHER_THUNDER));
	}
